...
describe('Fetch currency list', () => {
  it.skip('should return list of crypto currencies', async () => {
...
describe('fetch single currency', () => {
  it.skip('should return the html from CMC', async () => {
  ...
  it.skip('should return VEN from CMC', async () => {
  ...
  it.skip('should return the price', async () => {
    const html = await fetchCurrency('bitcoin', request)
